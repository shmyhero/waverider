...
from backtest.date_rules import EveryDayRule, WeekStartRule, WeekEndRule, MonthStartRule, MonthEndRule
...
def get_open_orders(asset=None, include_option=False):
    ...
    """
    return Order(Container.api).get_open_orders(asset, include_option)
...
def cancel_order(order_id):
    ...
    """
    Order(Container.api).cancel_order(order_id)
...
def set_stop_price(asset, stop_price):
    ...
    :return: order id
    """
    return Order(Container.api).set_stop_price(asset, stop_price)
